...
class JSONAltSchemaPlugin(plugin.PyangPlugin):
    def add_output_format(self, fmts):
        fmts['json-altschema'] = self

    def add_opts(self, optparser):
        optlist = [
            optparse.make_option('--json-altschema-debug',
                                 dest='schema_debug',
                                 action="store_true",
                                 help='JSON Alt Schema debug'),
            optparse.make_option('--json-altschema-path',
                                 dest='schema_path',
